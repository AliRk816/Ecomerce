        ...
        <div class="px-4 px-lg-0">
            ...
            <div class="container">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <div class="p-2">
                                    <img src="{{ asset('storage/' . $product->model->image) }}" alt="" width="70" height="70" class="img-fluid rounded shadow-sm">
                                ...
                                <td class="border-0 align-middle">
                                    <select name="qty" id="qty" data-id="{{ $product->rowId }}" data-stock="{{ $product->model->stock }}" class="custom-select">
                                        @for ($i = 1; $i <= 6 ; $i++)
                                            <option value= {{ $i }}>{{ $i }} {{ $i == $product->qty ? 'selected' : '' }}
                                            </option>
                                        @endfor
                                    </select>
                                </td>
                ...
                <div class="col-lg-6">
                    ...
                    @else
                    <div class="p-4">
                        <p class="font-italic mb-4">The coupon has been applied.</p>
                    </div>
                    @endif
                ...
                <div class="col-lg-6">
                    <div class="bg-light rounded-pill px-4 py-3 text-uppercase font-weight-bold">Order Info </div>
                    <div class="p-4">
                    ...
                    <ul class="list-unstyled mb-4">
                        ...
                        <li class="d-flex justify-content-between py-3 border-bottom"><strong class="text-muted">New Order Subtotal</strong><strong>
